...
create table users (id bigint not null, email varchar(128) null, username varchar(128) not null, password bigint unsigned not null, requiresNewPassword bit not null, salt int unsigned not null, disabled bit not null, createdTime datetime not null, modifiedTime datetime not null, primary key(id));
